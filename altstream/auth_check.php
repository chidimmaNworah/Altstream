...
define('CREDS_FILE', __DIR__ . '/../credentials.json');

function load_credentials() {
    if (file_exists(CREDS_FILE)) {
        $json = json_decode(file_get_contents(CREDS_FILE), true);
...
function save_credentials($username, $password) {
    ...
    return file_put_contents(CREDS_FILE, json_encode($data, JSON_PRETTY_PRINT)) !== false;
}
